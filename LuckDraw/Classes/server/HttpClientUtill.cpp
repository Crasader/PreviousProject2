...
void HttpClientUtill::onGetHttp(const char* Url, const cocos2d::network::ccHttpRequestCallback& callback)
{
...
void HttpClientUtill::onPostHttp(std::string postData, const char* Url, const cocos2d::network::ccHttpRequestCallback& callback, void* userData)
{
