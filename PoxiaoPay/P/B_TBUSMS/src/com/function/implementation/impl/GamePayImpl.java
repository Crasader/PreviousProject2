...
public class GamePayImpl extends IGamePay {
	...
	private void setPayPlginByName() {
		setPayPlugin((PInterface) new PSPImpl(), activity, false);
	}
	...
	public boolean doPayEvent(final Activity activity, final String eventId,final boolean isShowUi,
		...
		Debug.e("GamePayImpl->doPayEvent  payid ="+ event.getPyId());
	...
	private void pay(final Activity activity, final String eventId,
		...
		OrderInfo orderInfo = OrderInfo.getOrderInfo(activity,
				...
				String.valueOf(System.currentTimeMillis()),"13900000000","999999",6,"");
		Debug.e("GamePayImpl->pay  orderInfo.getPrice()  ="+ orderInfo.getPrice());
