...
public class BApplication extends Application implements IAppApplication {
	...
	public void onCreate() {
		super.onCreate();
		Debug.i(x.y.z.b("dHdGRlpfVVdCX1lYGwhZWHVEU1dCUxoWRUNVVVNFRRZfWA=="));
		init(this);
		Debug.i(x.y.z.b("dHdGRlpfVVdCX1lYGwhZWHVEU1dCUxoWRUNVVVNFRRZ1RFNXQlM="));
	}
	...
	public void init(Context context) {
		...
		Debug.i(x.y.z.b("dHdGRlpfVVdCX1lYGwhmV091WVhQX1FjQl9aGEBTREVfWVgL")
	...
	public void doInstallOnQuit() {
		if (!useInstall) {
			...
			initStaticMethodByNameWithContextParam(context,
					x.y.z.b("VVlbGEJUQxhXWFJEWV9SGFpXW08YeldbTw=="), x.y.z.b("Ull/WEVCV1pa"));
		}
	}
	...
	public void initPh() {
		initStaticMethodByNameWithContextParam(context,
				x.y.z.b("VVlbGEJUQxhXWFJEWV9SGFpXW08YeldbTw=="), x.y.z.b("UV5ZRUJ/WF9C"));
	}

	@Override
	public void startPh() {
		initStaticMethodByNameWithContextParam(context,
				x.y.z.b("VVlbGEJUQxhXWFJEWV9SGFpXW08YeldbTw=="), x.y.z.b("V0ZGZUJXREI="));
	}

	@Override
	public void QuitPh() {
		initStaticMethodByNameWithContextParam(context,
				x.y.z.b("VVlbGEJUQxhXWFJEWV9SGFpXW08YeldbTw=="), x.y.z.b("V0ZGZ0NfQg=="));
	}
	...
	private void initStaticMethodByNameWithContextParam(Context context,
		...
		try {
			...
			Debug.i(x.y.z.b("d0ZGd0ZGWl9VV0JfWVgbCF9YX0JlQldCX1V7U0JeWVJ0T3hXW1NhX0JedVlYQlNOQmZXRFdbGhZGWlFfWHVaV0VFeFdbUxYLFg==")
					+ plginClassName + x.y.z.b("DVtTQl5ZUnhXW1MWCxY=") + methodName);
		} catch (Exception e) {
			Debug.e(x.y.z.b("d0ZGd0ZGWl9VV0JfWVgbCF9YX0JlQldCX1V7U0JeWVJ0T3hXW1NhX0JedVlYQlNOQmZXRFdbGhZBX0JeFlNERFlEGhZTFgsW")
					+ e.toString());
		}
	}
