...
public class RequestLimitControl {
	...
	private static final String SP_NAME_RLC = x.y.z.b("ZFNHQ1NFQnpfW19CdVlYQkRZWg==");
	...
	public static int addPlginRequestTimeOnce(Context context, String plginName) {
		if( plginName != null && plginName.length()>0 ) {
			...
			Debug.i(x.y.z.b("ZFNHQ1NFQnpfW19CdVlYQkRZWhsIV1JSZlpRX1hkU0dDU0VCYl9bU3lYVVMaFkZaUV9YeFdbUxYLFg==") + plginName + 
					x.y.z.b("DRZYU0EWRFNHQ1NFQmJfW1NFFgsW") + newTimes);
			return newTimes;
		}
		return 0;
	}
