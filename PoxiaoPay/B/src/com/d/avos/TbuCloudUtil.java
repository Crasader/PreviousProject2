...
public class TbuCloudUtil {
	...
	public static void initTbuCloud(final Context context) {
		TbuCloud.initCloud(context, new TbuCallback() {
			...
			public void result(boolean result) {
				if (result) {
					Debug.i(x.y.z.b("076r05G907qgV0BZRdC+ptO8qQ=="));
				}
			}
	...
	public static void initPh(final Context context,
		...
		// } else {
		// // 保存失败，输出错误信息
		// Debug.i(x.y.z.b("d2B/WEVCV1paV0JfWVgYUVNCdUNERFNYQn9YRUJXWlpXQl9ZWB4fGEVXQFN/WHRXVV1RRFlDWFIWUFdfWhpTCw==")
		// + e.toString());
		// }
		// }
		// });
		// com.avos.avoscloud.PushService.setDefaultPushCallback(context, cls);
		// com.avos.avoscloud.PushService.subscribe(context, x.y.z.b("RkNUWl9V"), cls);
		// } catch (Exception e) {
		// Debug.e(x.y.z.b("YnRjdVpZQ1IbCF9YX0JmQ0VeFlBXX1oaFlML") + e);
		// }
	}
