    ...
    public static byte[] getResponseBodyAsByte(String url) {
        ...
        try {
            ...
            if (code == HttpURLConnection.HTTP_OK) {
                String chunked = http.getHeaderField(x.y.z.b("YkRXWEVQU0Qbc1hVWVJfWFE="));
            ...
            Log.e(TAG, x.y.z.b("c05VU0ZCX1lYDA==") + e.getMessage());
        } finally {
            if (null != is) {
                try {
                    is.close();
                } catch (IOException e) {
                    Log.d(TAG, x.y.z.b("f1hGQ0JlQkRTV1sYU05VU0ZCX1lYDA==") + e.getMessage());
                    e.printStackTrace();
                }
            }
            if (null != out) {
