...
public:
	...
	void HttpToPostRequestRegisterInfo(std::string channelId,long imei, int hd_type, int hd_factory);//注册请求
	void HttpToPostRequestLogInInfo(std::string channelId,std::string username,long imei, int hd_type, int hd_factory);//登录请求
